  <div class="w-full px-5 py-6 mx-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16">
      ...
      <div class="flex grid  grid-cols-12 pb-10 sm:px-5 gap-x-8 gap-y-16">
          <div class="flex flex-col border border-red-600 items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
              <a href="#_" class="">

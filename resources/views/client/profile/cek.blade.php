        ...
        <main class="w-full min-h-screen py-1 md:w-2/3 lg:w-3/4">
            <div class="p-2 md:p-4">
                <div class="w-full">
                    ...
                    <div class="flex justify-between">
                        <div class="py-4 flex ">
                            <img class="h-16 w-16 mr-4" src="{{ asset('img/aa.jpeg') }}" alt="Product image">
                            <div class="items-center">
                                <h1 class="font-semibold text-sm mb-2">Batik bandeng</h1>
                                <h1 class="font-semibold text-sm mb-2">Baju</h1>
                            </div>
                        </div>
                        <div class="py-4">
                            <h1>
                        ...
                        <div class="py-2 mt-4" id="harga">
                            <h1 class="bg-blue-600 px-2 rounded-lg text-white font-semibold py-1">
                                Selesai
                            </h1>
                        </div>

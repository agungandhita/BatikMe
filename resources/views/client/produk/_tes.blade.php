<div class="">
    ...
    <div class="w-full">
        <button
            class="btn top-0 border border-blue-500 bg-white rounded-xl text-blue-600 font-semibold md:p-2 capitalize text-sm hover:rounded-xl flex flex-wrap gap-x-3 text-xl w-full"

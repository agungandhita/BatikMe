...
@section('container')
    <div class="px-4 pt-6 bg-slate-200 dark:bg-gray-800">
                                ...
                                @foreach ($data as $no => $user)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            ...
                                            {{ Str::startsWith($user->no_tlpn, '0') ? $user->no_tlpn : '0' . $user->no_tlpn }}
                                        </td>
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $user->role }}</td>
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            <button type="button" data-modal-target="edit-user-modal{{ $no }}"
                                                data-modal-toggle="edit-user-modal{{ $no }}"
                                            ...
                                            <button type="button"
                                                data-modal-target="delete-user-modal{{ $no }}"
                                                data-modal-toggle="delete-user-modal{{ $no }}"
        ...
        <!-- Edit User Modal -->
        @foreach ($data as $ubah => $edit)
            <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                id="edit-user-modal{{ $ubah }}">
                <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <div class="p-6 space-y-6">
                            <form action="/profile/update/{{ $edit->user_id }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf

                                <img src="{{ asset('ft_user/' . $edit->image) }}" alt=""
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="last-name"
                                            ...
                                            telepon</label>
                                        <input type="number" name="no_tlpn" value="{{ $edit->no_tlpn }}"
                                            id="no_tlpn"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="08108308083" required>
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="email"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                                        <input type="email" name="email" value="{{ $edit->email }}" id="email"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="alamat" value="{{ $edit->alamat }}" id="alamat"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="jl.sugihwaras" required>
                                    </div>
                        ...
                        <form action="/profile/create" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    <label for="biography"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat</label>
                                    <textarea id="biography" rows="4" name="alamat"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Jl.Mawar RT RW 001/003"></textarea>
                                </div>
                            </div>
                    </div>
                    <!-- Modal footer -->
        ...
        @foreach ($data as $key => $delete)
            <!-- Delete User Modal -->
            <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                id="delete-user-modal{{ $key }}">

                <form action="/profile/delete/{{ $delete->user_id }}" method="POST">
                    @csrf
                    <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <div class="p-6 pt-0 text-center">
                                ...
                                <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">apakah anda yakin akan
